...
public class ConvertXlsToTestLinkXml {
	...
	public static void main(String[] args) {
		...
		try
		{
			...
			transformExcel(testcaseFile, desiredTestlinkXMLFile);
	...
	public static void transformExcel(String testcaseFile, String desiredTestlinkXMLFile)
	{
		try
		{
			...
			System.out.println(" ******* XML Is Created At : " +desiredTestlinkXMLFile);
		}catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public static Element createTestCaseNode(Document doc, Element testcases, String name, String summary, String	preconditions, String step_number, String actions, String  expectedresults)
	{
		...
		try
		{
			...
			System.out.println("Testcase node added  with name: "+name);
		}
		catch (Exception e) {
			e.printStackTrace();
		}
